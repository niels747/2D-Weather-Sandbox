precision highp int; // needed for chrome 97, older versions didn't need this
                     // specified
...
#define IRHeatingConst                                                         \
  0.000002 // 0.000005 how much a unit of IR (w/m2) adds or subsracts heat
